                            ...
                            Section -Style Heading4 'Security' {
                                ...
                                Section -Style Heading5 'Services' {
                                    ...
                                    if ($Healthcheck.VMHost.SSH) {
                                        ...
                                        $Services | Where-Object { ($_.'Name' -eq 'SSH') -and ($_.'Startup Policy' -ne 'Start and stop manually') } | Set-Style -Style Warning -Property 'Startup Policy'
                                    }
                                    if ($Healthcheck.VMHost.ESXiShell) {
                                        ...
                                        $Services | Where-Object { ($_.'Name' -eq 'ESXi Shell') -and ($_.'Startup Policy' -ne 'Start and stop manually') } | Set-Style -Style Warning -Property 'Startup Policy'
                                    }
                        ...
                        Section -Style Heading3 $VsanCluster.Name {
                            ...
                            Section -Style Heading4 'Disks' {
                                ...
                                if ($InfoLevel.vSAN -ge 4) {
                                    ...
                                    $vDisks | Select-Object 'Host', 'Disk Group', 'Name', 'Drive Type', 'Disk Tier', 'Capacity GB' | Table -Name 'vSAN Disks'
                                }
                            }

                            $VsanIscsiTargets = Get-VsanIscsiTarget -Cluster $VsanCluster.Cluster
                            if ($VsanIscsiTargets) {
                            ...
                            $VsanIscsiLuns = Get-VsanIscsiLun -Cluster $VsanCluster.Cluster | Sort-Object Name, LunId
                            if ($VsanIscsiLuns) {
                                Section -Style Heading4 'iSCSI LUNs' {
                                    $VsanIscsiLunInfo = foreach ($VsanIscsiLun in $VsanIscsiLuns) {
                                        [PSCustomobject]@{
                                            'Name' = $VsanIscsiLun.Name
                                    ...
                                    if ($InfoLevel.vSAN -ge 4) {
                                        ...
                                        $VsanIscsiLunInfo | Select-Object 'Name', 'LUN ID', 'Capacity GB', 'Used Capacity GB', 'State' | Table -Name 'iSCSI LUNs'
                                    }
                                }
                            }
                        }
